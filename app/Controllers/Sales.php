...
class Sales extends Secure_Controller
{
    ...
    public function postComplete(): RedirectResponse|string    // TODO: this function is huge.  Probably should be refactored.
    {
        ...
        $data['employee']             = trim($employee_info->first_name . ' ' . $employee_info->last_name);
    ...
    private function finalize_bigm_fiscal_data(array &$data): bool
    {
        ...
        try {
            ...
            $this->sale->save_bigm_fiscal_numbers(
                ...
                $praConfigured ? ($praFailed ? 0 : 1) : null,
                $fbrConfigured ? ($fbrFailed ? 0 : 1) : null,
            );
            ...
            // Mark both as failed so the retry cron can pick them up.
            $this->sale->save_bigm_fiscal_numbers(
                (int) $data['sale_id_num'],
                '',
                '',
                $praConfigured ? 0 : null,
                $fbrConfigured ? 0 : null,
            );
